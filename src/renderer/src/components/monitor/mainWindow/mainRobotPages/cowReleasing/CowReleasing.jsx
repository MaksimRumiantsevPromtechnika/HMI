  ...
  return (
    <>
      <div className="status-cow-in-cell-bar">
        <div className="status-wait-icon home-status-icon" style={{ display: (allState.i161 === 0 && main == "1") ? "" : "none" }} />
        <div className="status-cow-in-cell-icon home-status-icon" style={{ display: (allState.i161 === 0 && main == "7") ? "" : "none" }} />
        <div className="status-cow-icon home-status-icon" style={{ display: ((main == "8" && (allState.i598 === 0 && allState.i599 === 0) && (((milkingInfo.length - 1) >= 0 && (milkingInfo[milkingInfo.length - 1].milk).toFixed(1) == 0) || (milkingInfo.length) == 0) && allState.i161 === 0 && main == "8") || ((allState.i161 === 0 && main == "8" && ((allState.i598 === 1) || allState.i599 === 1)) && (milkingInfo.length) == 0)) ? "" : "none" }} />
        <div className="status-cow-milking-icon home-status-icon" style={{ display: ((main == "8" && (milkingInfo.length - 1) >= 0 && (milkingInfo[milkingInfo.length - 1].milk).toFixed(1) > 0) && allState.i161 === 0) && allState.i161 === 0 ? "" : "none" }} />
        <div className="pump-icon home-status-icon" style={{ display: allState.i161 === 1 ? "" : "none" }} />
        <div className="cow-in-cell-id" style={{ display: (allState.i161 === 1 ? "" : "none") }}>{pastCow}</div>
        <div className="cow-in-cell-id" style={{ display: ((allState.i161 === 1 || main == "1") ? "none" : "") }}>{cowInfo.id}</div>
      </div>

      <div className="status-milk-transport-bar" style={{ display: ((main == "1" && (allState.i598 === 1 || allState.i599 === 1)) || (main == "7") || (main == "8" && (allState.i598 === 1 || allState.i599 === 1) && (milkingInfo.length) == 0)) || allState.i161 === 1 ? "" : "none" }}>
        <div className="status-milk-transport-status">
          <div className="status-milk-status transport-status-pump" style={{ display: (allState.i598 === 1 || allState.i599 === 1) || allState.i161 === 1 ? "" : "none" }} />
          <div className="status-milk-status transport-status-ok" style={{ display: (allState.i598 === 0 && allState.i599 === 0) && allState.i161 === 0 ? "" : "none" }} />
        </div>
      ...
      <div className="milking-bar" style={{ display: (((main == "8" && (allState.i598 === 0 && allState.i599 === 0) && (milkingInfo.length) == 0) || (main == "8" && (milkingInfo.length) > 0)) && allState.i161 === 0) ? "" : "none" }}>
