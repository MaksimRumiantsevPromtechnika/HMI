        ...
        <div className='header-conteiner'>
          <div className='header-information'>
            ...
            <div className='milk-control' style={{ opacity: (currentMode == "8" || currentMode == "7" || currentMode == "9" ? 1 : 0) }}>
              ...
              <p className='milk-indication' style={{ display: (currentMode == "7" ? "" : "none") }}>{cowInfo.milkAvail >= 100 ? lastSuccessMilking.milkAmount : `${cowInfo.milkAvail}%`}/{(cowInfo.expmilk ? ((cowInfo.expmilk).toFixed(1)).replace(".", ",") : "0,0")}кг</p>
              <p className='milk-indication' style={{ display: (currentMode == "9" ? "" : "none") }}>{cowInfo.milkAvail >= 100 ? lastSuccessMilking.milkAmount : `${cowInfo.milkAvail}%`}/{(cowInfo.expmilk ? ((cowInfo.expmilk).toFixed(1)).replace(".", ",") : "0,0")}кг</p>
            </div>
            <div className='timer'>
